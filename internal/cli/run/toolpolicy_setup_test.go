...
func setupToolNames(t *testing.T, policy ToolPolicy) []string {
	...
	env, err := SetupEnv("", "", "", "", "", false /*noTools*/, true /*noSkills*/, true /*contextFiles*/, "", nil, nil /*pluginDirs*/, false /*memEnabled*/, policy)
	if err != nil {
...
func TestSetupEnvRejectsUnknownToolName(t *testing.T) {
	...
	_, err := SetupEnv("", "", "", "", "", false, true, true, "", nil, nil, false, NewToolPolicy([]string{"raed"}, nil))
	if err == nil {
...
func TestSetupEnvSkillsGatedOnFilteredReadTool(t *testing.T) {
	...
	withRead, err := SetupEnv("", "", "", "", "", false, false, true, "", nil, nil, false, ToolPolicy{})
	if err != nil {
	...
	withoutRead, err := SetupEnv("", "", "", "", "", false, false, true, "", nil, nil, false, NewToolPolicy(nil, []string{"read"}))
	if err != nil {
...
func TestSetupEnvNoToolsWithPolicyWarns(t *testing.T) {
	...
	stderr := captureStderr(t, func() {
		...
		env, err = SetupEnv("", "", "", "", "", true /*noTools*/, true /*noSkills*/, true /*contextFiles*/, "", nil, nil, false, NewToolPolicy([]string{"raed"}, nil))
	})
	if err != nil {
